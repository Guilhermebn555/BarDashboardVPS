...
import { Coffee, DollarSign, Package, ArrowLeft, ArrowLeftRight, Mic } from 'lucide-react'
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2 items-center w-full sm:w-auto">
            <Button variant="outline" size="sm" asChild className="flex-1 sm:flex-none sm:h-10">
              <Link href="/videoke" target="_blank" rel="noopener noreferrer">
                <Mic className="w-4 h-4 sm:mr-2" />
                <span className="hidden sm:inline">Videokê</span>
              </Link>
            </Button>
            <Button variant="outline" size="sm" asChild className="flex-1 sm:flex-none sm:h-10">
